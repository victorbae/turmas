	...
	<body>
		...
		<div class="container">
			<div class="row justify-content-sm-center">
				<h1 class="display-3 text-center" style="margin-top: 33px; margin-bottom: 33px;">Baesso</h1>
					...
					<table class="table table-striped table-bordered ">
					  ...
					  <tbody>
						  <c:forEach items="${turmaList}" var="turma">
						    <tr onclick="location.href='<c:url value="/turma/visualizar/${loteria.codigo}"/>'" class="pega-clique">
						      <td>${turma.nome}</td>
						    </tr>
						  </c:forEach>
					  </tbody>
